...
def parse_options(argv):
    ...
    sampleinput.add_option('-n', '--fn_bam', dest='fn_bam', metavar='FIlE', help='Specifies singl bam file',
                           default='-')
    ...
    sampleoutput.add_option('-m', '--fn_anno_tmp', dest='fn_anno_tmp', metavar='FILE',
                            help='Temp file for storing anno info',
                            default=os.path.join(os.path.realpath(__file__).rsplit('/', 1)[:-1][0], 'anno.tmp'))
